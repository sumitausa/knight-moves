...
const HowItWorks = props => {
  return (
    <div className="col-12 text-left">
      ...
      <p>
        Knight Moves Cafe is the premier board game cafe in the US! We offer
        espresso, cold drinks, sandwiches, and a huge collection of board games.
        Board Game Cafes are still new to the US, and they don’t all function
        exactly the same way. Here is a quick breakdown of how Knight Moves Cafe
        works.
      </p>
      <h3>Playing Games?</h3>
      <p>
        Pay the Game Fee and play as long as you want! The Game Fee covers you
        until we close, so you are free to leave and reenter as many times as
        you want!
      </p>
      ...
      <p>
        Play as many games as you want, for as long as you want, until we close!
      </p>
    </div>
  );
};
